                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <div class="card card-light">
                            <div class="card-header">
                                <h3 class="card-title">Create New Company Supervisor</h3>
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('company-supervisors.store') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{ route('company-supervisors.index') }}" class="btn btn-outline-danger">Cancel</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->

...
<div class="card">
    <div class="card-body">
        <form action="{{route('s.update', $project->id)}}" method="POST" autocomplete="off" id="edit-form"
            ...
            <div class="form-group">
                ...
                <select name="leaders[]" class="form-control select-ninja" multiple>
                    ...
                    <option value="{{$intern->id}}" @if(in_array($intern->id, collect($project->leaders)->pluck('id')->toArray())) selected @endif>{{$intern->intern_id}} ({{$intern->name}})</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="members[]" class="form-control select-ninja" multiple>
                    <option value="">-- Please Choose --</option>
                    @foreach ($interns as $intern)
                    <option value="{{$intern->id}}" @if(in_array($intern->id, collect($project->members)->pluck('id')->toArray())) selected @endif>{{$intern->intern_id}} ({{$intern->name}})</option>
                    @endforeach
                </select>
            </div>
